...
private:
    typedef std::uint32_t (Cop0State::*reg_read_t)(enum Cop0Registers reg) const;

    typedef void (
        Cop0State::*reg_write_t)(enum Cop0Registers reg, std::uint32_t value);
    ...
    void
    write_cop0reg_count_compare(enum Cop0Registers reg, std::uint32_t value);
