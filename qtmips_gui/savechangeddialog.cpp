    ...
    QDialog(parent)
{
    ...
    saveButton->setFocus();
    connect(cancelButton, &QAbstractButton::clicked, this, &SaveChnagedDialog::cancel_clicked);
    connect(ignoreButton, &QAbstractButton::clicked, this, &SaveChnagedDialog::ignore_clicked);
    connect(saveButton, &QAbstractButton::clicked, this, &SaveChnagedDialog::save_clicked);
