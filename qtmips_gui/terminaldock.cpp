...
void TerminalDock::setup(machine::SerialPort *ser_port) {
    ...
    connect(ser_port, &machine::SerialPort::rx_byte_pool,
            this, &TerminalDock::rx_byte_pool);
    connect(input_edit, &QLineEdit::textChanged,
            ser_port, &machine::SerialPort::rx_queue_check);
}
