...
MessagesDock::MessagesDock(QWidget *parent, QSettings *settings) : Super(parent) {
    ...
    connect(this, &MessagesDock::report_message,
            messages_model, &MessagesModel::insert_line);
    connect(this, &MessagesDock::pass_clear_messages,
            messages_model, &MessagesModel::clear_messages);
    connect(messages_content, &QAbstractItemView::activated,
            messages_model, &MessagesModel::activated);
    connect(messages_model, &MessagesModel::message_selected,
            this, &MessagesDock::message_selected);
}
