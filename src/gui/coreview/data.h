...
static const struct {
    ...
    const unordered_map<QStringView, const machine::RegisterValue &> REG {
        { QStringLiteral("alu-res"), dummy.reg },
        { QStringLiteral("alu-src1"), dummy.reg },
        { QStringLiteral("alu-src2"), dummy.reg },
        { QStringLiteral("decode-imm"), dummy.reg },
        { QStringLiteral("exec-imm"), dummy.reg },
        { QStringLiteral("fetched-value"), dummy.reg },
        { QStringLiteral("mem-in"), dummy.reg },
        { QStringLiteral("mem-out"), dummy.reg },
        { QStringLiteral("rs1"), dummy.reg },
        { QStringLiteral("rs2"), dummy.reg },
        { QStringLiteral("wb"), dummy.reg },
    };
    const unordered_map<QStringView, const machine::RegisterId &> REG_ID {
        { QStringLiteral("decode-rd"), dummy.regid },
        { QStringLiteral("exec-rd"), dummy.regid },
        { QStringLiteral("mem-rd"), dummy.regid },
        { QStringLiteral("rs1"), dummy.regid },
        { QStringLiteral("rs2"), dummy.regid },
        { QStringLiteral("wb-rd"), dummy.regid },
