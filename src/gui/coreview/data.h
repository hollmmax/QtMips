...
static const struct {
    ...
    const unordered_map<QStringView, const machine::RegisterValue &> REG {
        { u"alu-res", dummy.reg },  { u"alu-src1", dummy.reg },
        { u"alu-src2", dummy.reg }, { u"decode-imm", dummy.reg },
        { u"exec-imm", dummy.reg }, { u"fetched-value", dummy.reg },
        { u"mem-in", dummy.reg },   { u"mem-out", dummy.reg },
        { u"rs1", dummy.reg },      { u"rs2", dummy.reg },
        { u"wb", dummy.reg },
    };
    const unordered_map<QStringView, const machine::RegisterId &> REG_ID {
        { u"decode-rd", dummy.regid }, { u"exec-rd", dummy.regid },
        { u"mem-rd", dummy.regid },    { u"rs1", dummy.regid },
        { u"rs2", dummy.regid },       { u"wb-rd", dummy.regid },

    };
    const unordered_map<QStringView, const unsigned &> DEBUG {
        { u"cycle-count", dummy.d },    { u"decode-alu-op", dummy.d },
        { u"exec-alu-op", dummy.d },    { u"exec-forward-a", dummy.d },
        { u"exec-forward-b", dummy.d }, { u"stall-count", dummy.d },
    };
    ...
    const unordered_map<QStringView, InstructionData> INSTRUCTION {
        { u"fetch", { dummy.i, dummy.pc } },
        { u"decode", { dummy.i, dummy.pc } },
        { u"exec", { dummy.i, dummy.pc } },
        { u"mem", { dummy.i, dummy.pc } },
