...
CoreViewScene::CoreViewScene(
    ...
    {
        auto program_cache_tree = document.getRoot().find<QGraphicsItem>(
            "data-component", "program-cache");
    ...
    {
        auto data_cache_tree = document.getRoot().find<QGraphicsItem>(
            "data-component", "data-cache");
